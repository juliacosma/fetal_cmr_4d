...
STACKINDEX=0
SLICEINDEX=0
# TODO: this loop should skip masks from stacks/slices that user has specified should be excluded
...
STACKINDEX=0
SLICEINDEX=0
# TODO: this loop should skip slices from stacks/slices that user has specified should be excluded
for STACKMASK in ${STACKMASKFILES[@]}
do
